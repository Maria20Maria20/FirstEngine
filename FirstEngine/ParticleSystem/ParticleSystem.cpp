...
void ParticleSystem::Draw()
{
	...
	m_d3dContext->PSSetShaderResources(0u, 1u, m_texture->GetTextureResourceViewAddress());
	m_d3dContext->PSSetSamplers(0u, 1u, &textureSampler);
...
void ParticleSystem::SetBlendState(D3D11_BLEND_DESC particleBlendDesc)
{
	m_d3dDevice->CreateBlendState(&particleBlendDesc, &m_blendState);
}

void ParticleSystem::SetTexture(Texture* newTexture)
{
